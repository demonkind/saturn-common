...
public class SecureBase {
    ...
    //以下四项从配置文件读取
    private String sserver1_ip   = "192.168.0.47";
    private int    sserver1_port = 7100;

    private String sserver2_ip   = "192.168.0.47";

    private String monitor_ip;

    private int    monitor_port;

    SendToFnm      sendToFnm     = new SendToFnm(monitor_ip, monitor_port);
    ...
    private int sserver2_port = 7100;
