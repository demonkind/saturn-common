...
public class SendToFnm {
     ...
     * @return
     */
    private String sysIdConvert(String newSysId) {
     ...
     * @return
     */
    private String subSysIdConvert(String newSubSysId) {
     ...
     * @return
     */
    public int snd_fnm(char fault_level, String sys_id, String sub_sys_id, String err_id,
                       String err_desc) {
    ...
    int SendData(String fnm_ip, int fnm_port, StringBuffer sBuf) {
        Socket sid = null;
    ...
    void append(byte bData[], int Start, String s, int len, char mode) {
